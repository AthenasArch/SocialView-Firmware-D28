...
void ui_Alarm_screen_init(void)
{
    ...
    lv_label_set_text(ui_comp_get_child(ui_Alarm_Comp, UI_COMP_ALARM_COMP_ALARM_NUM2), "WEB");

    lv_obj_add_state(ui_comp_get_child(ui_Alarm_Comp, UI_COMP_ALARM_COMP_SWITCH1), LV_STATE_CHECKED);       /// States
    ...
    lv_obj_clear_state(ui_comp_get_child(ui_Alarm_Comp1, UI_COMP_ALARM_COMP_SWITCH1), LV_STATE_CHECKED);     /// States
    ...
    lv_obj_clear_state(ui_comp_get_child(ui_Alarm_Comp2, UI_COMP_ALARM_COMP_SWITCH1), LV_STATE_CHECKED);     /// States
